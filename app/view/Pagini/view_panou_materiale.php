	...
	<div style= "text-align:center;">
		<h1 style=" font-size: 2vw;">
			<a href="<?php echo BASE_URL;?>index.php/view_panou_elev">
				&#8810;
			</a>  Vizualizare materiale
		</h1>
	</div>
	<?php
		include_once "model/functii_select.php";
		$clasa = select_clase_elev($_SESSION['id_cont_elev']);
		if(count($clasa)>0){
			$result = select_materiale($clasa[0]['ID_Clasa']);
			if(count($result)>0){
				echo "
				...
				foreach ($result as $row) {
					echo "
						<tr>
							...
							<td>
								<a href='".BASE_URL."index.php/view_material_singur?id=".$row['ID_Material']."'>
				...
				echo "Nu exista materiale inca";
			}
		}else{
			echo "Nu faci parte din nicio clasa inca";
		}
	?>
</body>
</html>
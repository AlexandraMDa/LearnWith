...
<body>
	...
	?>
	<h1>Sigur doresti sa stergi aceasta nota?</h1>
	<section>
		...
		<?php
			echo "
			<a href='".BASE_URL."index.php/execute_sterge_nota?id=".$_GET['id']."'>
				<button id='reset_btn' style='width: 40%; background-color: red; float: right;'>Da, sterge nota</button>
			</a>
			";
		?>
	</section>

...
<body>
	...
	?>
	<div>
		<form method="POST" action="<?php echo BASE_URL;?>index.php/introdu_poza_parintedb" enctype="multipart/form-data">
			<?php if (file_exists("view/Surse_imag/Conturi/conturi_parinti/".$_SESSION['id_cont_parinte'].".jpg")){ ?>
			<img src="<?php echo BASE_URL;?>/view/Surse_imag/Conturi/conturi_parinti/<?php echo $_SESSION['id_cont_parinte'];?>.jpg" style="float: left; width: 50%; height: auto; border: 4px groove #ccc; padding: 2%">
			<?php }else{ ?>

...
<article>
	<a href="<?php echo BASE_URL;?>index.php/view_note_elev_discipline">
...
<article>
	<aside class="optiune">
		<img src="<?php echo BASE_URL; ?>/view/Surse_imag/Icons/plus.png" style="width:  3%; float: left;"> 
		Media generala:
		<?php
			include_once "model/functii_elev_note.php";
			$nota = sprintf('%0.2f',media_generala($_SESSION['id_cont_elev']));
			if($nota>-1) echo $nota;
			else echo "Nu ai note inca";
		?>
		<br>
	</aside>
	<aside class="optiune">
...
<article>
	<?php
		include_once "model/functii_elev_note.php";
		$note = list_note_general($_SESSION['id_cont_elev']);
		if(count($note)>0){
			echo "

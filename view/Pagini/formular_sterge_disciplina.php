...
<body>
	...
	<h1>Sigur doresti sa stergi aceasta disciplina?</h1>
	<section>
		<a href="<?php echo BASE_URL;?>index.php/view_discipline_general">
			<button id="reset_btn" style="width: 40%; color: white; background-color: RoyalBlue;">Nu, inapoi la pagina principala</button>
		</a>
		<?php
			echo "
			<a href='".BASE_URL."index.php/execute_sterge_disciplina?id=".$_GET['id']."'>
				<button id='reset_btn' style='width: 40%; background-color: red; float: right; color: white;'>Da, sterge disciplina</button>
			</a>
			";
		?>
	</section>

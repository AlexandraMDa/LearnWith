...
<body>
	...
	<?php
		...
		$result = data_nota($_GET['id']);
	?>
	<form method="POST" action="<?php echo BASE_URL;?>index.php/edit_notadb">
		<input type="hidden" name="id_nota" value="<?php echo $result[0]['ID_Nota'];?>">
		<label for="data">Data: </label>
		<input type="date" name="data" value="<?php echo $result[0]['Data_nota'];?>">
		<br>
		<label for="nota">Nota: </label>
		<input type="text" name="nota" value="<?php echo $result[0]['Nota'];?>">
		<br>
		<div class="clear">
